...
class Wsu_Mailingservices_Model_Mail_Type_ProductAlert_StockEmail extends Wsu_Mailingservices_Model_Mail_Type_ProductAlert_Abstract
{
    const TYPE = 'test_product_stock_alert_email_template';
    ...
    {
        $block = Mage::helper('productalert')->createBlock('productalert/email_stock');
