...
/**
 * An SMTP self test for the MailingServices Magento extension
 *
...
class Wsu_MailingServices_IndexController
	...
	public function indexAction() {
		...
		$body = 
			...
			"tips for using it please visit wsu.edu.\n\n" .
			"Regards,\nJeremy Bass";

	        $mail->addTo($to)
	        	->setFrom("jeremy.bass@wsu.edu")//@todo abstract this
        		->setSubject($sub)
	            ->setBodyText($body);
